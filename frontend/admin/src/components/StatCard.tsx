    ...
    <div className="card flex items-start justify-between">
      <div>
        ...
        <div className="flex items-center gap-1 mt-2">
          {trend === 'up' ? <TrendingUp size={14} className="text-emerald-500" /> : <TrendingDown size={14} className="text-red-500" />}
          <span className={`text-xs font-medium ${trend === 'up' ? 'text-emerald-600' : 'text-red-600'}`}>{change}</span>
