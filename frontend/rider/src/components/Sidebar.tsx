...
import {
  LayoutDashboard, ShoppingCart, Wallet, User,
...
const sections = [
  {
    title: 'OVERVIEW',
    items: [
      { href: '/orders', label: 'Home', icon: LayoutDashboard },
    ],
  },
  {
    title: 'DELIVERIES',
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-100 relative">
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            ...
            <span className="block text-[11px] text-gray-400 font-medium tracking-wide">RIDER</span>
          </div>
        )}
        ...
        {collapsed ? (
          ...
          <div className="flex items-center gap-3 px-2 py-2">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-sm font-semibold text-gray-900 truncate">{user?.email?.split('@')[0] || 'Rider'}</p>
