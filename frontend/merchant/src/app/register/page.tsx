...
export default function RegisterPage() {
  ...
  const handleGoogleCredential = useCallback(
    ...
    [businessName, fullName, otpCode, phone, router, signupWithGoogle],
  );
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1.5">Business Name (optional)</label>
            <input
              className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg text-gray-900 text-sm"
              value={businessName}
              onChange={(e) => setBusinessName(e.target.value)}
              placeholder="JD Store"
            />
          </div>
