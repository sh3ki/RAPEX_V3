    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 lg:ml-64 p-6">
        <div className="mb-6">
          ...
          <p className="text-dark-muted text-sm mt-1">Profile and account settings</p>
        </div>
        ...
        <div className="max-w-2xl space-y-6">
          ...
          <div className="card space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <p className="text-dark-muted text-sm">Name</p>
                <p className="text-white font-medium">{user?.first_name} {user?.last_name}</p>
              </div>
              <div>
                <p className="text-dark-muted text-sm">Role</p>
                <p className="text-white font-medium flex items-center gap-2">
          ...
          <div className="card space-y-2">
            ...
            <p className="text-dark-muted text-sm">RAPEX Merchant Portal v1.0.0</p>
            <p className="text-dark-muted text-sm">Build: Phase 11 — Next.js Frontend</p>
          </div>
        </div>
      </main>
    </div>
