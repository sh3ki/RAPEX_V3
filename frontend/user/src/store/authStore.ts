...
export const useAuthStore = create<AuthState>((set) => ({
  ...
  loginWithPassword: async (identifier, password, role = 'USER') => {
  ...
  loginWithGoogle: async (idToken, role = 'USER') => {
  ...
  requestMagicLink: async (email, role = 'USER', redirectUrl = '') => {
  ...
  verifyMagicLink: async (email, token, role = 'USER') => {
