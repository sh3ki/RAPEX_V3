...
import {
  Home, ShoppingCart, ShoppingBag, Wallet,
  Bell, Gift, User, LogOut, ChevronLeft, ChevronRight,
} from 'lucide-react';
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-100 relative">
        ...
        {!collapsed && (
          <div className="overflow-hidden">
            ...
            <span className="block text-[11px] text-gray-400 font-medium tracking-wide">USER</span>
          </div>
        )}
