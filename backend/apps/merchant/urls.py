...
urlpatterns = [
    ...
    path('stores/<uuid:pk>/upload-asset/', views.MerchantStoreAssetUploadView.as_view(), name='merchant-store-upload-asset'),
    path('stores/<uuid:pk>/upload-product-image/', views.MerchantProductImageUploadView.as_view(), name='merchant-upload-product-image'),
    ...
    path('onboarding/verify-otp/', views.MerchantOnboardingVerifyOtpView.as_view(), name='merchant-onboarding-verify-otp'),
